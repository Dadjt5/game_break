...
export const translations = {
  es: {
    ...
    homeExpl: "Bienvenido a nuestra web oficial. Revisa los salones de la fama de cada juego y descubre si eres de esos pocos jugadores que han superado un logro legendario.",
  ...
  en: {
    ...
    homeExpl: "Welcome to our official website. Check out the halls of fame for each game and find out if you are one of the few players who have achieved a legendary achievement.",
